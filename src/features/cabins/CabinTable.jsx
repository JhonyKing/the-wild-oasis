  ...
  const sortedCabins = filteredCabins.sort(
    (a, b) =>
      typeof a[field] === "string"
        ? a[field].localeCompare(b[field]) * modifier //this compare strings
        : (a[field] - b[field]) * modifier //this compare numbers
  );
...
return (
  <table hover>
    ...
    <tbody>
      {" "}
      {cabins?.map((cabins, index) => (
        <Row>
          <tr>
            <td key={index}>e{cabins.id}</td>
            <td key={index}>e{cabins.name}</td>
            <td key={index}>e{cabins.maxCapacity}</td>
            <td key={index}>d{cabins.regularPrice}</td>
            <td key={index}>d{cabins.description}</td>
          </tr>
        </Row>
      ))}
    </tbody>
